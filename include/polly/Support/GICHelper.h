...
operator<<(llvm::DiagnosticInfoOptimizationBase &OS, const isl::UnionMap &Obj) {
  OS << Obj.getStr();
  return OS;
}
...
/// C++11 closures.
void foreachElt(const isl::UnionMap &UMap,
...
/// C++11 closures.
void foreachElt(const isl::UnionSet &USet,
...
/// closures.
void foreachElt(const isl::UnionPwAff &UPwAff,
...
isl_stat foreachEltWithBreak(const isl::UnionMap &UMap,
...
///         if the collection was initially empty.
isl_stat
foreachPieceWithBreak(const isl::PwAff &PwAff,
