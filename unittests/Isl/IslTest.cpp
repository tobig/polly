...
#define SET(Str) isl::Set::readFromStr(Ctx.get(), Str)
#define MAP(Str) isl::Map::readFromStr(Ctx.get(), Str)

#define USET(Str) isl::UnionSet::readFromStr(Ctx.get(), Str)
#define UMAP(Str) isl::UnionMap::readFromStr(Ctx.get(), Str)
...
static bool operator==(const isl::BasicSet &LHS, const isl::BasicSet &RHS) {
  return bool(LHS.isEqual(RHS));
}
...
static bool operator==(const isl::BasicMap &LHS, const isl::BasicMap &RHS) {
  return bool(LHS.isEqual(RHS));
}
...
static bool operator==(const isl::UnionSet &LHS, const isl::UnionSet &RHS) {
  return bool(LHS.isEqual(RHS));
}

static bool operator==(const isl::UnionMap &LHS, const isl::UnionMap &RHS) {
  return bool(LHS.isEqual(RHS));
}
...
TEST(Isl, APIntToIslVal) {
...

  {
    ...
    EXPECT_TRUE(IslOne.isOne());
  }

  {
    APInt APNTwo(2, -2, true);
    auto IslNTwo = valFromAPInt(IslCtx, APNTwo, true);
    auto IslNTwoCmp = isl::Val::intFromSi(IslCtx, -2);
...

  {
    ...
    auto IslRef = isl::Val::intFromUi(IslCtx, 71);
...
TEST(Isl, IslValToAPInt) {
  ...
  {
    auto IslNOne = isl::Val::intFromSi(IslCtx, -1);
  ...
  {
    auto IslNTwo = isl::Val::intFromSi(IslCtx, -2);
  ...
  {
    auto IslNThree = isl::Val::intFromSi(IslCtx, -3);
  ...
  {
    auto IslNFour = isl::Val::intFromSi(IslCtx, -4);
  ...
  {
    auto IslZero = isl::Val::intFromUi(IslCtx, 0);
  ...
  {
    auto IslOne = isl::Val::intFromUi(IslCtx, 1);
  ...
  {
    auto IslTwo = isl::Val::intFromUi(IslCtx, 2);
  ...
  {
    auto IslThree = isl::Val::intFromUi(IslCtx, 3);
  ...
  {
    auto IslFour = isl::Val::intFromUi(IslCtx, 4);
  ...
  {
    auto IslNOne = isl::Val::intFromUi(IslCtx, (1ull << 32) - 1);
    auto APNOne = APIntFromVal(IslNOne);
  ...
  {
    auto IslLargeNum = isl::Val::intFromUi(IslCtx, 60);
    IslLargeNum = IslLargeNum.two_exp();
    IslLargeNum = IslLargeNum.subUi(1);
  ...
  {
    auto IslExp = isl::Val::intFromUi(IslCtx, 500);
  ...
  {
    auto IslExp = isl::Val::intFromUi(IslCtx, 512);
    auto IslLargePow2 = IslExp.two_exp();
    auto APLargePow2 = APIntFromVal(IslLargePow2);
    EXPECT_TRUE(APLargePow2.isPowerOf2());
...
TEST(Isl, Foreach) {
  ...
  auto MapSpace = isl::Space::alloc(Ctx.get(), 0, 1, 1);
  auto TestBMap = isl::BasicMap::universe(MapSpace);
  TestBMap = TestBMap.fixSi(isl::Dim::Out, 0, 0);
  TestBMap = TestBMap.fixSi(isl::Dim::Out, 0, 0);
  isl::Map TestMap = TestBMap;
  isl::UnionMap TestUMap = TestMap;

  auto SetSpace = isl::Space::setAlloc(Ctx.get(), 0, 1);
  isl::BasicSet TestBSet = isl::Point::zero(SetSpace);
  isl::Set TestSet = TestBSet;
  isl::UnionSet TestUSet = TestSet;

  {
    auto NumBMaps = 0;
    TestMap.foreachBasicMap([&](isl::BasicMap BMap) -> isl::Stat {
  ...
  {
    auto NumBSets = 0;
    TestSet.foreachBasicSet([&](isl::BasicSet BSet) -> isl::Stat {
  ...
  {
    auto NumMaps = 0;
    TestUMap.foreachMap([&](isl::Map Map) -> isl::Stat {
  ...
  {
    auto NumSets = 0;
    TestUSet.foreachSet([&](isl::Set Set) -> isl::Stat {
  ...
  {
    auto UPwAff =
        isl::UnionPwAff::valOnDomain(TestUSet, isl::Val::zero(Ctx.get()));
    auto NumPwAffs = 0;
    UPwAff.foreachPwAff([&](isl::PwAff PwAff) -> isl::Stat {
      EXPECT_TRUE(PwAff.isCst());
      NumPwAffs++;
      return isl::Stat::OK;
    });
  ...
  {
    auto TestPwAff =
        isl::PwAff::valOnDomain(TestSet, isl::Val::zero(Ctx.get()));
    auto NumPieces = 0;
    TestPwAff.foreachPiece([&](isl::Set Domain, isl::Aff Aff) -> isl::Stat {
      EXPECT_EQ(Domain, TestSet);
      EXPECT_TRUE(Aff.isCst());
      NumPieces++;
      return isl::Stat::Error;
    });
