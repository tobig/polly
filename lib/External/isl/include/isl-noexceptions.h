...
public:
  ...
  static inline Aff zeroOnDomain(LocalSpace ls);
  static inline Aff valOnDomain(LocalSpace ls, Val val);
...
public:
  ...
  inline explicit LocalSpace(Space obj);
...
public:
  ...
  static inline Point zero(Space dim);
...
public:
  ...
  static inline PwAff zeroOnDomain(LocalSpace ls);
  static inline PwAff valOnDomain(Set domain, Val v);
...
public:
  ...
  static inline Space alloc(Ctx ctx, unsigned int nparam, unsigned int n_in, unsigned int n_out);
  static inline Space setAlloc(Ctx ctx, unsigned int nparam, unsigned int dim);
  static inline Space setFromParams(Space space);
...
public:
  ...
  static inline UnionAccessInfo fromSink(UnionMap sink);
...
public:
  ...
  static inline UnionPwAff valOnDomain(UnionSet domain, Val v);
...
public:
  ...
  static inline UnionPwMultiAff fromDomain(UnionSet uset);
...
public:
  ...
  static inline Val intFromUi(Ctx ctx, unsigned long u);
...
Aff Aff::zeroOnDomain(LocalSpace ls) {
  auto res = isl_aff_zero_on_domain(ls.release());
  return manage(res);
}
Aff Aff::valOnDomain(LocalSpace ls, Val val) {
...
LocalSpace::LocalSpace(Space obj) {
  ptr = isl_local_space_from_space(obj.release());
}
...
PwAff PwAff::zeroOnDomain(LocalSpace ls) {
  auto res = isl_pw_aff_zero_on_domain(ls.release());
  return manage(res);
}
PwAff PwAff::valOnDomain(Set domain, Val v) {
...
Space Space::alloc(Ctx ctx, unsigned int nparam, unsigned int n_in, unsigned int n_out) {
  auto res = isl_space_alloc(ctx.release(), nparam, n_in, n_out);
  return manage(res);
}
Space Space::setAlloc(Ctx ctx, unsigned int nparam, unsigned int dim) {
  auto res = isl_space_set_alloc(ctx.release(), nparam, dim);
  return manage(res);
}
Space Space::setFromParams(Space space) {
  auto res = isl_space_set_from_params(space.release());
  return manage(res);
}
...
UnionAccessInfo UnionAccessInfo::fromSink(UnionMap sink) {
...
UnionPwAff UnionPwAff::valOnDomain(UnionSet domain, Val v) {
...
UnionPwMultiAff UnionPwMultiAff::fromDomain(UnionSet uset) {
...
Val Val::intFromUi(Ctx ctx, unsigned long u) {
