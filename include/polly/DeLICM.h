...
///
/// Used by unittesting.
bool isConflicting(isl::UnionSet ExistingOccupied, isl::UnionSet ExistingUnused,
                   isl::UnionSet ExistingWrites, isl::UnionSet ProposedOccupied,
                   isl::UnionSet ProposedUnused, isl::UnionSet ProposedWrites,
